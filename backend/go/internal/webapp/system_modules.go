...
func localizeUpdatesHTML(value, language string) string {
	...
	return strings.NewReplacer(
		...
		"Paquets disponibles", "Available packages", "Paquet", "Package", "Architecture", "Architecture", "Installée", "Installed", "Candidate", "Candidate", "Dépendances Composer", "Composer dependencies", "Vérifier maintenant", "Check now", "Détails", "Details", "Détail", "Detail", "Site", "Site",
